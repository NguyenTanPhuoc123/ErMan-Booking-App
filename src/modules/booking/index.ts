...
export const getListImageBooking = createAction<Models.IActionGeListImageBookingPayload>(Models.GET_LIST_IMAGE_BOOKING);
export const addListImageBooking = createAction<Models.IActionAddListImageBookingPayload>(Models.ADD_LIST_IMAGE_BOOKING);
